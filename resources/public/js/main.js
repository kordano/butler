...
cljs.core.with_meta = function with_meta(b, c) {
  return function() {
    ...
    "undefined" === typeof cljs.core.t4929 && (cljs.core.t4929 = {}, cljs.core.t4929 = function(b, c, f, g) {
      this.meta = b;
      this.o = c;
      this.with_meta = f;
      this.meta4930 = g;
...
var butler = {core:{}};
butler.core.http = cljs.nodejs.require.call(null, "http");
butler.core.greetHandler = function(a, b) {
  b.writeHead(200, cljs.core.PersistentArrayMap.fromArray(["Content-Type", "text/plain"], !0));
  b.end("Hello World");
  return b
};
butler.core.server = function(a, b, c) {
  return butler.core.http.createServer(a).listen(b, c)
};
butler.core._main = function() {
  var a = function(a) {
    butler.core.server.call(null, butler.core.greetHandler, 1337, "127.0.0.1");
    return cljs.core.println.call(null, "Server running at http://127.0.0.1:1337/")
  }, b = function(b) {
    var d = null;
    0 < arguments.length && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
cljs.core._STAR_main_cli_fn_STAR_ = butler.core._main;
cljs.nodejscli = {};
